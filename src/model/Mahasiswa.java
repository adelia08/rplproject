...
@NamedQueries({
    ...
    , @NamedQuery(name = "Mahasiswa.findByAngkatan", query = "SELECT m FROM Mahasiswa m WHERE m.angkatan ="
            + " :angkatan")
    , @NamedQuery(name = "Mahasiswa.findBySekolahAsal", query = "SELECT m FROM Mahasiswa m WHERE m.sekolahAsal ="
            + " :sekolahAsal")})
